...
class mapper {
    static generate(file) {
        ...
        let members = [];
        try {
            let lines = utils_1.Utils.read_all_lines(file);
            let line_num = 0;
            let last_type = '';
            let last_indent = 0;
            lines.forEach(line => {
                ...
                function parse_as_class(keyword, line) {
                ...
                function parse_as_class_member(accessor) {
...
//# sourceMappingURL=mapper_js.js.map